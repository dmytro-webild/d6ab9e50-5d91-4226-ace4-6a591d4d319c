...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      negativeCard={{
        items: [
          "No generic teaching methods",          "No crowded classrooms",          "No lack of individual guidance",          "No outdated study materials",          "No compromise on student focus"],
      }}
      positiveCard={{
        items: [
          "Proven systematic curriculum",          "Expert faculty mentorship",          "Personalized performance tracking",          "Weekly mock test analysis",          "Dedicated doubt-clearing sessions"],
      }}
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        { id: "p6", name: "Maths Mastery", price: "₹6,000", imageSrc: "http://img.b2bpic.net/free-photo/graduation-high-school-university-concept-space-text_185193-110156.jpg" },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      useInvertedBackground={true}
      metrics={[
        { id: "m1", value: "95%", description: "Pass Rate in Board Exams" },
        { id: "m2", value: "1200+", description: "Students Selected for JEE/NEET" },
        { id: "m3", value: "15+", description: "Years of Excellence" },
        { id: "m4", value: "50+", description: "Expert Educators" },
        { id: "m5", value: "100%", description: "Curriculum Completion" },
      ]}
      ...
      groups={[
        {
          id: "g1",          groupTitle: "Academic Leaders",          members: [
            ...
            {
              id: "tm3",              title: "Ms. S. Verma",              subtitle: "Biology Lead",              detail: "Expertise in NEET-level medical biology.",              imageSrc: "http://img.b2bpic.net/free-photo/front-view-business-woman-posing_23-2149457736.jpg"},
          ],
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "f1", title: "What are the timings?", content: "Classes are held from 8 AM to 6 PM." },
        { id: "f2", title: "Is demo class available?", content: "Yes, we offer two days of free trial classes." },
        { id: "f3", title: "Do you offer online classes?", content: "Yes, we have integrated hybrid learning options." },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        { title: "Resources", items: [{ label: "Blog", href: "#" }, { label: "FAQs", href: "#faq" }] },
      ]}
    />
  </div>
      </ReactLenis>
